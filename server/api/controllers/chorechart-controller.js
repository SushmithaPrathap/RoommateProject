import * as chorechartService from "../services/chorechart-services.js";
...
export const post = async (request, response) => {
  try {
    ...
    const chorechart = await chorechartService.save(payload);
...
export const index = async (request, response) => {
  try {
    ...
    const chorechartItem = await chorechartService.search(query);
...
export const get = async (request, response) => {
  try {
    ...
    const chorechartItem = await chorechartService.get(id);
    setSuccessRes(chorechartItem, response);
  } catch (error) {
    setErrorRes(error, response);
  }
...
export const update = async (request, response) => {
  try {
    ...
    const chorechartItem = await chorechartService.update(updateItem);
    setSuccessRes(chorechartItem, response);
  } catch (error) {
    setErrorRes(error, response);
  }
...
export const remove = async (request, response) => {
  try {
    const id = request.params.id;
    const chorechartItem = await chorechartService.remove(id);
