...
const UserNavBar = ({ logoutHandler, path, text }) => {
  ...
  //   const handleLogout = () => {navigate('/goodbye');}
  //   function handleLogout(e){
  //     e.preventDefault();
  //     const logput = apiAuth.logout()
  //   }
  ...
  console.log("rre", userList);

  return (
    <Disclosure as="nav" className="bg-white shadow mb-3">
      {({ open }) => (
        <>
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center">
                ...
                >
                  ...
                  {Object.keys(userList).length === 0 ? (
                    <button class="bg-indigo-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer self-center">
                      Register
                    </button>
                  ) : (
